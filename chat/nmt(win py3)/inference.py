...
__all__ = ["load_data", "inference",
           "single_worker_inference_m", "single_worker_inference", "multi_worker_inference"]
...
def inference_m(ckpt,
  ...
  return model_helper.create_infer_model(model_creator, hparams, scope)
...
def single_worker_inference_m(infer_model,
  ...
  """Inference with a single worker.
    The modified version of single_worker_inference. 
    The input and output are not saved into file but returned to the caller.
    Inference indices is removed.
  """
